...
export default async function changeCustomizationSettings(item: string, value: any): Promise<void> {
...
export async function changeCustomsSettings(item: string, value: any): Promise<void> {
    const customsConfig = await getCustomsConfig();
    const config = await getConfig();
