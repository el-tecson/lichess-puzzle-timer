...
export default function TimePicker({
    ...
    const [hInit = '00', mInit = '00', sInit = '00']: string[] = initialState.split(':');
        ...
        <div className="time-picker-root number" {...props}>
            ...
            <Dialog open={open} onClose={() => setOpen(false)} className="duration-dialog">
                ...
                <DialogPanel className="duration-panel noselect">
                    <p className="duration-panel-name">{label}</p>
                    <div className="time-picker-dialog-inner number">
                        {/* HOURS */}
                        <div className="listbox-wrapper">
                            <Listbox
                                value={hour}
                                onChange={(hour) => handleChange({ hour, minute, second })}
                            >
                        ...
                        <div className="listbox-wrapper">
                            <Listbox
                                value={minute}
                                onChange={(minute) => handleChange({ hour, minute, second })}
                            >
                        ...
                        <div className="listbox-wrapper">
                            <Listbox
                                value={second}
                                onChange={(second) => handleChange({ hour, minute, second })}
                            >
